      ...
      <div className="max-w-4xl mx-auto">
        ...
        <main id="main-content">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
            ...
            <h2 className="text-2xl font-semibold text-[#213988] mt-8 mb-4">הסדרי נגישות מבנים / קבלת קהל</h2>
            <p>
              החברה פועלת כיום במתכונת דיגיטלית ואינה מקבלת קהל במשרדים פיזיים. כלל תהליכי הגיוס, הראיונות והשירותים שלנו ניתנים באופן מקוון (כגון שיחות וידאו) או טלפוני. במידה ונדרשת התאמת נגישות ספציפית לראיון המקוון, נשמח לעמוד לרשותכם ולספק מענה מתאים.
            </p>
