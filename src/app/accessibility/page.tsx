        ...
        <main id="main-content">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
            ...
            <ul className="list-disc list-inside space-y-2 pr-4">
              ...
              <li><strong>תיאורי תמונות (Alt Text):</strong> לחלק מהותי מהתמונות המופיעות באתר מצורף טקסט חלופי קולי (Alt).</li>
          ...
          <div className="mt-12 text-sm text-gray-500">
            * הצהרת הנגישות תקפה ונכונה לתאריך כתיבתה. במקרה ויחולו שינויים מהותיים באתר תעודכן הצהרה זו בהתאם.
          </div>
        </main>
      </div>
    </div>
